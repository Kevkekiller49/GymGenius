...
photo1 = ImageTk.PhotoImage(image1)  # reates a PhotoImage object from the resized image
...
def start():
    ...
    intro_photo = ImageTk.PhotoImage(intro_image)  # reates a PhotoImage object from the resized image
